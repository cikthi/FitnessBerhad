...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">FitnessBerhad Gym</a></h1>
</div>
<!--close-Header-part--> 
    ...
    <div class="row-fluid">
     ...
     <div class="widget-content">
            ...
            <div class="row-fluid">
                ...
                <h4>Dear, <?php echo $row['fullname']; ?> <br> Weight Variation of <em style="color:green"><?php include 'actions/progress-percent.php';?>%</em> as per current updates! <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><br/> <br/>  <br/></h4><p>Thank you for choosing our services.<br/>- on the behalf of whole team</p>
                </div>
                <div class="pull-right">
                  <h4><span>Approved By:</h4>
                  <img src="../img/report/signature.png" width="124px;" alt=""><p class="text-center">Note:AutoGenerated</p> </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Web Design By Cik Thi</a> </div>
</div>
