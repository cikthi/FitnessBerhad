    ...
    <div class="span6">
      <div class="widget-box">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            // Assuming that quantity is always 1 for services
            $total = 0;
            if ($service == "Fitness") {
                $total = 55;
            } elseif ($service == "Sauna") {
                $total = 35;
            } elseif ($service == "Cardio") {
                $total = 40;
            }
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="number" placeholder="50" name="amount" class="span11" value="<?php echo ('$total'); ?>">
                  </div>
              </div>
            </div>
